...
// Header: Instrument Settings (fixed)
const advHeader = el("div", { class: "ge-advHeader" });
const advHeaderLabel = el("div", { class: "ge-advHeaderLabel" }, ["Instrument Settings"]);
const advInstrumentGrid = el("div", { class: "ge-advInstrumentGrid" });
advHeader.append(advHeaderLabel, advInstrumentGrid);

// Presets row (fixed)
const advPresetsRow = el("div", { class: "ge-advPresetsRow" });
const advPresetsLabel = el("div", { class: "ge-advPresetsLabel" }, ["Presets A–J"]);
const advPresetsHost = el("div", { class: "ge-advPresetsHost" });
advPresetsRow.append(advPresetsLabel, advPresetsHost);

// Main + Bottom grids
const advGrids = el("div", { class: "ge-advGrids" });

const advMainGrid = el("div", { class: "ge-advMainGrid" });
const advColA = el("div", { class: "ge-advCol ge-advColA" });
const advColB = el("div", { class: "ge-advCol ge-advColB" });
advMainGrid.append(advColA, advColB);

const advBottomGrid = el("div", { class: "ge-advBottomGrid" });
const advColABottom = el("div", { class: "ge-advCol ge-advColABottom" });
const advColBBottom = el("div", { class: "ge-advCol ge-advColBBottom" });
advBottomGrid.append(advColABottom, advColBBottom);

advGrids.append(advMainGrid, advBottomGrid);

// Assemble wing
advFlyout.append(advFlyoutTitleBar, advHeader, advPresetsRow, advGrids);
...
advCloseBtn.addEventListener("click", closeFlyout);
window.addEventListener("keydown", (e) => {
  if (e.key === "Escape" && !advFlyout.classList.contains("hidden")) closeFlyout();
});
